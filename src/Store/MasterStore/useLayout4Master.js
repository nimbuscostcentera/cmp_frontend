// store/useLayout4Master.js
import { create } from "zustand";
import axios from "axios";
import {
  AddLayout4MasterAPI,
  UpdateLayout4MasterAPI,
  DeleteLayout4MasterAPI,
} from "../../Apis/MasterApis";

const useLayout4Master = create((set, get) => ({
  layout4: [], // generic array for any Layout4 master
...
export default useLayout4Master;
