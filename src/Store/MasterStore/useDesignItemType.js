...
const useDesignItemType = create((set, get) => ({
  DesignItemType: [],
  ...
  // =====================================================
  // FETCH DesignItemType LIST
  // =====================================================
  fetchDesignItemType: async (type, ID_Header) => {
  ...
  // =====================================================
  // UPDATE DesignItemType (FormData)
  // =====================================================
  updateDesignItemType: async (type, id, data) => {
  ...
  // =====================================================
  // DELETE DesignItemType
  // =====================================================
  deleteDesignItemType: async (type = "prm", id) => {
  ...
  addItemType: async (type, newItem, ID_Header) => {
    set({
      addIsLoading: true,
      addError: null,
      addIsSuccess: false,
...
export default useDesignItemType;
